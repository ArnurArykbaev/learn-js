...
let admin;
let someName; //someName instead name 
...
let planetX = "Неизвестная планета";
...
/* 
    Ответ: 
    Да, но нежелательно. В таком случае есть смысл создать для таких переменных файл .env и вынести туда глобальные константы. А затем их уже импортировать в отдельные файлы. Часто такими константами 
    будут переменные API, пароли, ссылки и др. переменные, которые часто используются. В самих модулях желательно придерживаться нижнего регистра
*/