...
/* 
    Проверка на пустоту
    важность: 5
    Напишите функцию isEmpty(obj), которая возвращает true, если у объекта 
    нет свойств, иначе false.
...
// Да, т.к. объект не меняется, а меняется его внутреннее наполнение
