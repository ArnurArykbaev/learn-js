...
//     const withoutDash = string.split("");
//     const resArr = withoutDash.map((word, index) => index === 0 ? word : word[0].toUpperCase() + word.slice(1));
...
// function onlyNames(arrObj) {
//     const res = arrObj.map((el, id) => {
//         return el.name
//     })
//     return res
// }
